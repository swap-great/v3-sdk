import { BigintIsh, Token } from '@cndllabs/sdk-core'
import { Interface } from '@ethersproject/abi'
import ISelfPermit from '@cndllabs/v3-periphery/artifacts/contracts/interfaces/ISelfPermit.sol/ISelfPermit.json'
