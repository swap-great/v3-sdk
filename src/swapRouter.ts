...
import { BigintIsh, Currency, CurrencyAmount, Percent, TradeType, validateAndParseAddress } from '@cndllabs/sdk-core'
...
import ISwapRouter from '@cndllabs/v3-periphery/artifacts/contracts/SwapRouter.sol/SwapRouter.json'
